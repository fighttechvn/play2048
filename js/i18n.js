/* GoBrain landing — lightweight i18n.
 ...
 * Persists choice in localStorage("gobrain.lang"); auto-detects device language.
...
(function () {
  ...
  var T = {
    vi: {
      ...
      "store.getiton": "Tải trên", "store.betaon": "Bản beta trên", "store.downloadon": "Tải trên", "store.noinstall": "Không cài đặt", "store.playonline": "Chơi online",
      ...
      "hero.sub": "Chọn một trò chơi từ bảng Khám phá và bắt đầu ngay. Go Brain gồm 2048 cổ điển cùng Zip (nối số) và Patch (xếp hình logic) — mỗi game 99 màn, hiệu ứng mượt mà, giao diện sáng &amp; tối, sáu ngôn ngữ và trải nghiệm gọn gàng, không quảng cáo.",
      "cta.playnow": "▶ Chơi ngay", "cta.download": "Tải ứng dụng",
      "hero.meta1": "3 trò chơi · mỗi game 99 màn", "hero.meta2": "Không quảng cáo",
      ...
      "feat.eyebrow": "Vì sao chọn Go Brain", "feat.h2": "Một sân chơi nhỏ đầy câu đố trí tuệ — làm thật chỉn chu",
      "feat.p": "Ba trò chơi tự tay xây dựng trong một ứng dụng gọn gàng, hiện đại và đề cao quyền riêng tư.",
      "m1.h3": "Ba game trong một", "m1.p": "GoBrain, Zip và Patch — chọn từ bảng Khám phá và đổi bất cứ lúc nào.",
      ...
      "m2.h3": "Riêng tư từ thiết kế", "m2.p": "Không tài khoản, không quảng cáo, không lập hồ sơ người dùng. Dữ liệu trò chơi của bạn ở lại trên thiết bị.",
      "m2.li1": "Không thu thập dữ liệu trò chơi — điểm số chỉ ở trên máy bạn", "m2.li2": "Hoạt động hoàn toàn ngoại tuyến", "m2.li3": "Không cần đăng ký, không cần cấp quyền",
      ...
      "stats.l1": "Trò chơi trí tuệ", "stats.l2": "Màn mỗi game", "stats.l3": "Ngôn ngữ", "stats.l4": "Mạng quảng cáo",
      "how.eyebrow": "Học trong 60 giây", "how.h2": "Cách chơi", "how.p": "Mỗi trò chơi dễ bắt đầu nhưng khó dừng lại.",
      "s1.h3": "GoBrain — ghép", "s1.p": "Vuốt để trượt mọi ô. Hai số bằng nhau ghép thành gấp đôi. Leo tới 2048 và xa hơn.",
      ...
      "ctaband.h2": "Sẵn sàng chơi?", "ctaband.p": "Mở hub và chơi thử cả ba trò chơi ngay trên trình duyệt, hoặc cài Go Brain lên điện thoại.",
      "footer.about": "Một hub câu đố trí tuệ nhanh, hiện đại, đề cao quyền riêng tư — GoBrain, Zip và Patch. Bởi FightTech.",
      ...
      "footer.rights": "Bảo lưu mọi quyền.", "footer.disclaimer": "2048 là một ý tưởng câu đố mở; Go Brain là một bản dựng độc lập."
    },

    ko: {
      "nav.games": "게임", "nav.features": "특징", "nav.how": "플레이 방법",
      "nav.play": "온라인 플레이", "nav.download": "다운로드", "nav.sdk": "SDK", "nav.support": "지원",
      "store.getiton": "다운로드", "store.betaon": "베타", "store.downloadon": "다운로드", "store.noinstall": "설치 불필요", "store.playonline": "온라인 플레이",
      ...
      "hero.sub": "Discover 허브에서 게임을 골라 바로 시작하세요. Go Brain에는 클래식 2048과 Zip(숫자 경로), Patch(도형 논리)가 들어 있습니다 — 각 99레벨, 부드러운 애니메이션, 라이트 &amp; 다크 테마, 6개 언어, 그리고 광고 없는 깔끔한 경험.",
      "cta.playnow": "▶ 지금 플레이", "cta.download": "앱 다운로드",
      "hero.meta1": "게임 3종 · 각 99레벨", "hero.meta2": "광고 없음",
      ...
      "feat.eyebrow": "Go Brain을 선택하는 이유", "feat.h2": "제대로 만든 작은 두뇌 퍼즐 아케이드",
      "feat.p": "깔끔하고 현대적이며 개인정보를 우선하는 앱 하나에 직접 만든 게임 셋.",
      "m1.h3": "게임 3종을 하나로", "m1.p": "GoBrain, Zip, Patch — Discover 허브에서 골라 언제든 전환하세요.",
      "m1.li1": "퍼즐마다 정교하게 다듬은 99레벨", "m1.li2": "매끄러운 애니메이션과 햅틱 피드백", "m1.li3": "진행 상황과 최고 점수를 자동 저장",
      "m2.h3": "설계부터 프라이버시", "m2.p": "계정도, 광고도, 프로파일링도 없습니다. 게임 데이터는 기기에 남습니다.",
      "m2.li1": "게임 데이터 수집 없음 — 점수는 기기에만 저장", "m2.li2": "완전한 오프라인 작동", "m2.li3": "가입 불필요, 권한 요청 없음",
      ...
      "stats.l1": "두뇌 게임", "stats.l2": "게임당 레벨", "stats.l3": "언어", "stats.l4": "광고 네트워크",
      "how.eyebrow": "60초면 배운다", "how.h2": "플레이 방법", "how.p": "모든 게임이 시작은 쉽고 멈추기는 어렵습니다.",
      "s1.h3": "GoBrain — 병합", "s1.p": "밀어서 모든 타일을 이동. 같은 숫자 둘이 두 배로 합쳐집니다. 2048, 그 너머까지.",
      ...
      "ctaband.h2": "플레이할 준비 됐나요?", "ctaband.p": "허브를 열어 브라우저에서 세 게임을 바로 즐기거나, Go Brain을 휴대폰에 설치하세요.",
      "footer.about": "빠르고 현대적이며 개인정보를 우선하는 두뇌 퍼즐 허브 — GoBrain, Zip, Patch. FightTech 제작.",
      ...
      "footer.rights": "모든 권리 보유.", "footer.disclaimer": "2048은 공개된 퍼즐 콘셉트이며, Go Brain은 독립적으로 제작된 빌드입니다."
    },

    zh: {
      "nav.games": "游戏", "nav.features": "功能", "nav.how": "玩法",
      "nav.play": "在线玩", "nav.download": "下载", "nav.sdk": "SDK", "nav.support": "支持",
      "store.getiton": "下载于", "store.betaon": "测试版", "store.downloadon": "下载于", "store.noinstall": "免安装", "store.playonline": "在线玩",
      ...
      "hero.sub": "从「发现」面板选一款游戏即可开玩。Go Brain 集合了经典 2048、Zip（数字连线）和 Patch（形状逻辑）——每款 99 关，动画顺滑，深浅双主题，六种语言，纯净无广告。",
      "cta.playnow": "▶ 立即开玩", "cta.download": "下载应用",
      "hero.meta1": "3 款游戏 · 每款 99 关", "hero.meta2": "无广告",
      ...
      "feat.eyebrow": "为什么选 Go Brain", "feat.h2": "一个用心打造的小型益智游戏厅",
      "feat.p": "三款纯手工打造的游戏，集于一个简洁、现代、注重隐私的应用之中。",
      "m1.h3": "三合一游戏", "m1.p": "GoBrain、Zip 和 Patch——从「发现」面板挑选，随时切换。",
      "m1.li1": "每款谜题 99 个精调关卡", "m1.li2": "顺滑动画与触感反馈", "m1.li3": "自动保存进度与最高分",
      "m2.h3": "隐私优先设计", "m2.p": "无账号、无广告、不做用户画像。你的游戏数据保留在设备上。",
      "m2.li1": "不收集游戏数据——分数只保存在本地", "m2.li2": "完全离线运行", "m2.li3": "无需注册，无需任何权限",
      ...
      "stats.l1": "益智游戏", "stats.l2": "每款关卡", "stats.l3": "语言", "stats.l4": "广告网络",
      "how.eyebrow": "60 秒就学会", "how.h2": "玩法", "how.p": "每款游戏都易上手，却让人欲罢不能。",
      "s1.h3": "GoBrain — 合并", "s1.p": "滑动让所有方块移动。两个相同数字合并翻倍。一路冲上 2048，乃至更高。",
      "s2.h3": "Zip — 连线", "s2.p": "描绘一条贯穿每个格子的连续路径，按 1 到 N 的顺序经过数字圆点。",
      "s3.h3": "Patch — 分割", "s3.p": "将网格切成矩形，使每个矩形包含一个等于其面积的数字。",
      "ctaband.h2": "准备好开玩了吗？", "ctaband.p": "打开中心，在浏览器里立刻试玩全部三款游戏，或将 Go Brain 安装到手机上。",
      "footer.about": "一个快速、现代、隐私优先的益智谜题中心——GoBrain、Zip 和 Patch。由 FightTech 出品。",
      ...
      "footer.rights": "保留所有权利。", "footer.disclaimer": "2048 是一个开放的谜题概念；Go Brain 是独立开发的版本。"
    },

    ja: {
      "nav.games": "ゲーム", "nav.features": "特長", "nav.how": "遊び方",
      "nav.play": "オンラインで遊ぶ", "nav.download": "ダウンロード", "nav.sdk": "SDK", "nav.support": "サポート",
      "store.getiton": "入手:", "store.betaon": "ベータ版", "store.downloadon": "ダウンロード", "store.noinstall": "インストール不要", "store.playonline": "オンライン",
      ...
      "hero.sub": "「発見」ハブから好きなゲームを選んですぐにプレイ。Go Brain にはクラシックな 2048、Zip（数字の道）、Patch（図形ロジック）を収録 — 各99レベル、なめらかなアニメーション、ライト &amp; ダークテーマ、6言語、そして広告のないすっきりした体験。",
      "cta.playnow": "▶ 今すぐプレイ", "cta.download": "アプリをダウンロード",
      "hero.meta1": "3ゲーム · 各99レベル", "hero.meta2": "広告なし",
      ...
      "feat.eyebrow": "Go Brain を選ぶ理由", "feat.h2": "しっかり作り込んだ小さな脳トレパズルの遊び場",
      "feat.p": "手作りの3つのゲームを、シンプルでモダン、プライバシー第一のアプリに凝縮。",
      "m1.h3": "3つのゲームが1つに", "m1.p": "GoBrain・Zip・Patch — 「発見」ハブから選び、いつでも切り替え。",
      "m1.li1": "各パズルに丁寧に調整した99レベル", "m1.li2": "なめらかなアニメーションと触覚フィードバック", "m1.li3": "進行状況とベストスコアを自動保存",
      "m2.h3": "設計からプライバシー重視", "m2.p": "アカウントなし、広告なし、プロファイリングなし。ゲームデータは端末に保存されます。",
      "m2.li1": "ゲームデータの収集なし — スコアは端末内のみ", "m2.li2": "完全オフラインで動作", "m2.li3": "登録不要、権限要求なし",
      ...
      "stats.l1": "脳トレゲーム", "stats.l2": "ゲームごとのレベル", "stats.l3": "言語", "stats.l4": "広告ネットワーク",
      "how.eyebrow": "60秒で覚えられる", "how.h2": "遊び方", "how.p": "どのゲームも始めるのは簡単、やめるのは難しい。",
      "s1.h3": "GoBrain — マージ", "s1.p": "スワイプで全タイルを移動。同じ数字2つが倍に合体。2048、そしてその先へ。",
      "s2.h3": "Zip — つなぐ", "s2.p": "すべてのマスを通る連続した経路を描き、番号の点を1からNまで順に通過。",
      "s3.h3": "Patch — 分割", "s3.p": "グリッドを長方形に切り分け、それぞれが面積に等しい数字を1つ含むようにします。",
      "ctaband.h2": "遊ぶ準備はいい？", "ctaband.p": "ハブを開いてブラウザで3つのゲームをすぐに試すか、Go Brain をスマホにインストール。",
      "footer.about": "高速・モダン・プライバシー第一の脳トレパズルハブ — GoBrain・Zip・Patch。FightTech 制作。",
      ...
      "footer.rights": "全著作権所有。", "footer.disclaimer": "2048 はオープンなパズルのコンセプトであり、Go Brain は独立した制作物です。"
    },
    ...
    ar: {
      ...
      "store.getiton": "متوفر على", "store.betaon": "نسخة بيتا على", "store.downloadon": "متوفر على", "store.noinstall": "بدون تثبيت", "store.playonline": "العب أونلاين",
      ...
      "hero.sub": "اختر لعبة من لوحة «اكتشف» وابدأ فورًا. يجمع Go Brain لعبة 2048 الكلاسيكية مع Zip (مسارات الأرقام) وPatch (منطق الأشكال) — 99 مرحلة لكل لعبة، حركات سلسة، وضعان فاتح &amp; داكن، ست لغات، وتجربة نظيفة بلا إعلانات.",
      "cta.playnow": "▶ العب الآن", "cta.download": "حمّل التطبيق",
      "hero.meta1": "3 ألعاب · 99 مرحلة لكل لعبة", "hero.meta2": "بلا إعلانات",
      ...
      "feat.eyebrow": "لماذا Go Brain", "feat.h2": "صالة ألعاب صغيرة من ألغاز الذكاء — مصنوعة بإتقان",
      "feat.p": "ثلاث ألعاب مصنوعة يدويًا في تطبيق واحد أنيق وعصري يضع الخصوصية أولًا.",
      "m1.h3": "ثلاث ألعاب في واحد", "m1.p": "GoBrain وZip وPatch — اخترها من لوحة «اكتشف» وبدّل في أي وقت.",
      "m1.li1": "99 مرحلة مضبوطة بعناية في كل لغز", "m1.li2": "حركات سلسة واستجابة لمسية", "m1.li3": "حفظ تلقائي لتقدّمك وأفضل نتائجك",
      "m2.h3": "الخصوصية بالتصميم", "m2.p": "بلا حساب، بلا إعلانات، بلا تكوين ملف شخصي. تبقى بيانات لعبتك على جهازك.",
      "m2.li1": "لا جمع لبيانات اللعبة — تبقى نتيجتك على جهازك", "m2.li2": "يعمل بدون إنترنت تمامًا", "m2.li3": "بلا تسجيل، وبلا أذونات مطلوبة",
      ...
      "stats.l1": "ألعاب ذهنية", "stats.l2": "مراحل لكل لعبة", "stats.l3": "لغات", "stats.l4": "شبكات إعلانية",
      "how.eyebrow": "تتعلّمها في 60 ثانية", "how.h2": "طريقة اللعب", "how.p": "كل لعبة سهلة البداية ويصعب تركها.",
      "s1.h3": "GoBrain — دمج", "s1.p": "مرّر لتحريك كل المربعات. يندمج رقمان متساويان ليتضاعفا. اصعد إلى 2048 وأبعد.",
      ...
      "ctaband.h2": "جاهز للعب؟", "ctaband.p": "افتح المركز وجرّب الألعاب الثلاث فورًا في متصفحك، أو ثبّت Go Brain على هاتفك.",
      "footer.about": "مركز ألغاز ذهنية سريع وعصري يضع الخصوصية أولًا — GoBrain وZip وPatch. من FightTech.",
      ...
      "footer.rights": "جميع الحقوق محفوظة.", "footer.disclaimer": "2048 فكرة لغز مفتوحة؛ وGo Brain نسخة مستقلة."
    }
  };
