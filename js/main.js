...
(function () {
  ...
  function getPref() {
    try { return localStorage.getItem("gobrain.theme") || "system"; } catch (e) { return "system"; }
  }
  apply(getPref());
  ...
  if (themeSelect) {
    ...
    themeSelect.addEventListener("change", function () {
      try { localStorage.setItem("gobrain.theme", themeSelect.value); } catch (e) {}
  ...
  // ----- Footer app version -----
  // Stamped into <meta name="app-version"> at site assembly. Show it only when
  // resolved (skip the literal "__APP_VERSION__" placeholder of an unstamped build).
  ...
  if (verEl && ver && ver.indexOf("__") !== 0) verEl.textContent = " · v" + ver;
})();
